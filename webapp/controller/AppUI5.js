	...
	return ("com.apptech.app-retention.controller.AppUI5", {
		...
		*/
		generateUDTCode: function (Database,docType) {
			...
			$.ajax({
				url: "https://xsjsv10.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName="+ Database +"&procName=SPAPP_GENERATENUMBER&DocType="+ docType,
				type: "GET",
				async: false,
		...
		fErrorLogs: function (sTableAffected,sOperation,sKey1,sKey2,sErrorDesc,sProcess,sProcessBy,sKey3,Database,BatchLogs) {
			...
			$.ajax({
				url: "https://slv10.biotechfarms.net/b1s/v1/U_APP_ERRORLOGS",
				type: "POST",
        ...
        fGetButtons: function(sDatabase,sUserCode,sModule){
			var aReturnResult = [];
			$.ajax({
				url: "https://xsjsv10.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName="+ sDatabase +"&procName=spAppRetention&QUERYTAG=getButtons" +
