	...
	return ("com.apptech.app-retention.controller.AppUI5", {
		...
		*/
		generateUDTCode: function (Database,docType) {
			...
			$.ajax({
				url: "https://18.141.110.57:4300/app_xsjs/ExecQuery.xsjs?dbName="+ Database +"&procName=SPAPP_GENERATENUMBER&DocType="+ docType,
				type: "GET",
				async: false,
        ...
        fGetButtons: function(sDatabase,sUserCode,sModule){
			var aReturnResult = [];
			$.ajax({
				url: "https://18.141.110.57:4300/app_xsjs/ExecQuery.xsjs?dbName="+ sDatabase +"&procName=spAppRetention&QUERYTAG=getButtons" +
