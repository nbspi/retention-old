sap.ui.define([
	...
	return Controller.extend("com.apptech.app-retention.controller.Login", {
		...
		fgetAllRecords: function(queryTag){
			...
			// var aReturnResult = [];
			$.ajax({
				url: "https://xs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=011122_PROD_BIOTECH&procName=spAppRetention&QUERYTAG="+ queryTag +"&value1=&value2=&value3=&value4=",
				type: "GET",
				dataType: "json",
