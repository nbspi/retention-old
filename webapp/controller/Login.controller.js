sap.ui.define([
	...
	return Controller.extend("com.apptech.app-retention.controller.Login", {
		...
		onLogin: function (oEvent) {
			...
			$.ajax({
				url: "https://slv10.biotechfarms.net/b1s/v1/Login",
		...
		fgetAllRecords: function(queryTag){
			...
			// var aReturnResult = [];
			$.ajax({
				url: "https://xsjsv10.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=PROD_BIOTECH&procName=spAppRetention&QUERYTAG="+ queryTag +"&value1=&value2=&value3=&value4=",
				type: "GET",
				dataType: "json",
