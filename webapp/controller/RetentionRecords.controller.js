sap.ui.define([
  ...
  return Controller.extend("com.apptech.app-retention.controller.RetentionRecords", {
	...
	fGetAllRecords: function (queryTag,Param) {
		...
		$.ajax({
		  url: "https://xsjs.biotechfarms.net/app-xsjs/ExecQuery.xsjs?dbName=" + this.Database + "&procName=spAppRetention&queryTag=" + queryTag +"&value1=" + Param + "&value2=&value3=&value4=",
		  type: "GET",
