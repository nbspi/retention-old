sap.ui.define([
  ...
  return Controller.extend("com.apptech.app-retention.controller.RetentionRecords", {
	...
	fGetAllRecords: function (queryTag,Param) {
		...
		$.ajax({
		  url: "https://test-saphanav10.biotechfarms.net/xsjs/app_xsjs/ExecQuery.xsjs?dbName=" + this.Database + "&procName=spAppRetention&queryTag=" + queryTag +"&value1=" + Param + "&value2=&value3=&value4=",
		  type: "GET",
