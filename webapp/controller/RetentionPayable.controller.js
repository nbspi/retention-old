	...
	return Controller.extend("com.apptech.app-retention.controller.RetentionPayable", {
		...
		onSave: function () {
			...
			// Proceed Transaction in Draft
				...
				if (SupplierCode !== "") {
					...
					$.ajax({
						url: "https://18.142.200.63:50000/b1s/v1/$batch",
						type: "POST",
		...
		onUpdate: function (oHeaderCode, oDetaileCode) {
			...
			$.ajax({
				...
				url: "https://18.142.200.63:50000/b1s/v1/U_APP_ORPT('" + oHeaderCode + "')",
				...
				$.ajax({
					...
					url: "https://18.142.200.63:50000/b1s/v1/U_APP_RPT1('" + oDetaileCode + "')",
		...
		onSavingDownPayment: function () {
			...
			if (SupplierCode === "") {
				...
				$.ajax({
					url: "https://18.142.200.63:50000/b1s/v1/PurchaseDownPayments",
		...
		onSavingFirstProgressBilling: function () {
			...
			if (SupplierCode === "") {
				...
				//Posting GRPO in SAP
				$.ajax({
					url: "https://18.142.200.63:50000/b1s/v1/PurchaseDeliveryNotes",
					...
					if (results) {
						...
						$.ajax({
							...
							if (FirstProgress) {
								...
								$.ajax({
									url: "https://18.142.200.63:50000/b1s/v1/PurchaseInvoices",
					...
					if (results) {
						...
						var GRPODocEntry = results.DocEntry;
								...
								// For Closing A/P Invoice	
										...
										// $.ajax({
										// 	url: "https://18.142.200.63:50000/b1s/v1/PurchaseDeliveryNotes(" + GRPODocEntry + ")/Close",
										// 	type: "POST",
										// 	async:false,
										// 	xhrFields: {
										// 		withCredentials: true
		...
		fUpdateAPInvoice: function (DocEntry,DocNum){
			...
			$.ajax({
				url: "https://18.142.200.63:50000/b1s/v1/PurchaseInvoices(" + DocEntry + ")",
		...
		$.ajax({
			url: "https://18.142.200.63:50000/b1s/v1/Attachments2",
			data: form,
			type: "POST",
			processData:false,
