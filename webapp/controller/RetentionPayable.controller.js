  ...
  "use strict";
	...
	return Controller.extend("com.apptech.app-retention.controller.RetentionPayable", {
		...
		oGetDatafromHeaderUDT: function (oDocStatus) {
			...
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=" + this.Database +
			...
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=" + this.Database + "&procName=spAppRetention&queryTag=getUDThdr&value1=" +
					sCode +
			...
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=" + this.Database + "&procName=spAppRetention&queryTag=getUDTdtl&value1=" +
					sCode +
					"&value2=" + oDocStatus + "&value3=&value4=",
					type: "GET",
					beforeSend: function(xhr) {
		...
		fFilterPurchaseOrderTransaction: function (queryTag) {
			...
			this.oModelOpenPO = new JSONModel();
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=" + this.Database + "&procName=spAppRetention&queryTag=" + queryTag +
		...
		fGetRetentionProcess: function () {
			...
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=" + oDatabase +
		...
		fGenerateUDTCode: function (docType) {
			...
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=" + this.Database + "&procName=SPAPP_GENERATENUMBER&DocType=" + docType,
				type: "GET",
				async: false,
				beforeSend: function (xhr) {
					xhr.setRequestHeader("Authorization", "Basic " + btoa("SYSTEM:Qwerty0987"));
			...
			if (SupplierCode === "") {
				...
				$.ajax({
					...
					if (results) {
						...
						$.ajax({
							url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=" + oDatabase + "&procName=spAppRetention&	queryTag=getAPINVDoc&value1=" + PoDocEntry + "&value2=&value3=&value4=",
							type: "GET",
							async:false,
							beforeSend: function (xhr) {
								xhr.setRequestHeader("Authorization", "Basic " + btoa("SYSTEM:Qwerty0987"));
		...
		fgetPOLineTotal: function (DocNum,Row){
			...
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=" + this.Database + "&procName=spAppRetention&queryTag=getPOLineTotal&value1=" + DocNum + "&value2=" + Row + "&value3=&value4=",
					type: "GET",
					async: false,
				  beforeSend: function (xhr) {
					xhr.setRequestHeader("Authorization", "Basic " + btoa("SYSTEM:Qwerty0987"));
		...
		fgetFirstBillCWIP: function (QueryTag,DocEntry){
			...
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=" + this.Database + "&procName=spAppRetention&queryTag="+ QueryTag +"&value1=" + DocEntry +"&value2=&value3=&value4=",
					type: "GET",
					async: false,
				  beforeSend: function (xhr) {
					xhr.setRequestHeader("Authorization", "Basic " + btoa("SYSTEM:Qwerty0987"));
		...
		fgetPORetention: function (DocEntry){
			...
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=" + this.Database +"&procName=spAppRetention&queryTag=getPORentAmount&value1=" + DocEntry + "&value2=&value3=&value4=",
					type: "GET",
					async: false,
				  beforeSend: function (xhr) {
					xhr.setRequestHeader("Authorization", "Basic " + btoa("SYSTEM:Qwerty0987"));
		...
		fRetTransaction: function (DocEntry,Row){
			...
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=" + this.Database +"&procName=spAppRetention&queryTag=getRetentionTransaction&value1=" + DocEntry + "&value2="+ Row +"&value3=&value4=",
					type: "GET",
					async: false,
				  beforeSend: function (xhr) {
					xhr.setRequestHeader("Authorization", "Basic " + btoa("SYSTEM:Qwerty0987"));
