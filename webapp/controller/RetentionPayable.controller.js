	...
	return Controller.extend("com.apptech.app-retention.controller.RetentionPayable", {
		...
		onUpdate: function (oHeaderCode, oDetaileCode) {
			...
			$.ajax({
				...
				url: "https://test-sapsldv10.biotechfarms.net/b1s/v1/U_APP_ORPT('" + oHeaderCode + "')",
				...
				$.ajax({
					...
					url: "https://test-sapsldv10.biotechfarms.net/b1s/v1/U_APP_RPT1('" + oDetaileCode + "')",
		...
		onSavingDownPayment: function () {
			...
			if (SupplierCode === "") {
				...
				$.ajax({
					url: "https://test-sapsldv10.biotechfarms.net/b1s/v1/PurchaseDownPayments",
		...
		onSavingFirstProgressBilling: function () {
			...
			if (SupplierCode === "") {
				...
				//Posting GRPO in SAP
				$.ajax({
					url: "https://test-sapsldv10.biotechfarms.net/b1s/v1/PurchaseDeliveryNotes",
					...
					if (results) {
						...
						$.ajax({
							...
							if (FirstProgress) {
								...
								$.ajax({
									url: "https://test-sapsldv10.biotechfarms.net/b1s/v1/PurchaseInvoices",
					...
					if (results) {
						...
						var GRPODocEntry = results.DocEntry;
								...
								// For Closing A/P Invoice	
										...
										// $.ajax({
										// 	url: "https://test-sapsldv10.biotechfarms.net/b1s/v1/PurchaseDeliveryNotes(" + GRPODocEntry + ")/Close",
										// 	type: "POST",
										// 	async:false,
										// 	xhrFields: {
										// 		withCredentials: true
		...
		fUpdateAPInvoice: function (DocEntry,DocNum){
			...
			$.ajax({
				url: "https://test-sapsldv10.biotechfarms.net/b1s/v1/PurchaseInvoices(" + DocEntry + ")",
