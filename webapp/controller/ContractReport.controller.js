sap.ui.define([
  ...
  return Controller.extend("com.apptech.app-retention.controller.ContractReport", {
	...
	fGetAllRecord:function(QueryTag,value1,value2,value3,value4){
		...
		$.ajax({
			url: "https://xs.biotechfarms.net$/app-xsjs/ExecQuery.xsjs?dbName=" + this.Database + "&procName=spAppRetention_Report&queryTag=" + QueryTag +"&value1=" + value1 + "&value2=" + value2 + "&value3=" + value3 + "&value4="+ value4 ,
			type: "GET",
			async: false,
			beforeSend: function(xhr) {
			  xhr.setRequestHeader("Authorization", "Basic " + btoa("SYSTEM:P@ssw0rd805~"));
