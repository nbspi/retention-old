  ...
  return Controller.extend("com.apptech.app-retention.controller.ContractReport", {
	...
	fConfigValueHelpDialogs: function () {
		...
		var sInputValue = this.byId("BPCode").getValue();
			...
			$.ajax({
				url: "https://18.142.200.63:4300$/app-xsjs/ExecQuery.xsjs?dbName=" + Database +
	...
	fGetAllRecord:function(QueryTag,value1,value2,value3,value4){
		...
		$.ajax({
			url: "https://18.142.200.63:4300$/app-xsjs/ExecQuery.xsjs?dbName=" + this.Database + "&procName=spAppRetention_Report&queryTag=" + QueryTag +"&value1=" + value1 + "&value2=" + value2 + "&value3=" + value3 + "&value4="+ value4 ,
			type: "GET",
			async: false,
			beforeSend: function(xhr) {
			  xhr.setRequestHeader("Authorization", "Basic " + btoa("SYSTEM:Qwerty0987"));
